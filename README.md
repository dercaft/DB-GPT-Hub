...
```
poetry run python dbgpt_hub/eval/evaluation.py --plug_value --input /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/output/pred/mindsourse_4bit_cleaned.sql --gold /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/data/DuSQL/gold_dev_cleaned.sql --db /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/data/DuSQL/database/ --table /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/data/DuSQL/db_schema.json

poetry run python dbgpt_hub/eval/evaluation.py --plug_value --input /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/output/pred/sqlcoder_4bit_cleaned.sql --gold /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/data/DuSQL/gold_dev_cleaned.sql --db /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/data/DuSQL/database/ --table /data/lcy/elec/DB-GPT-Hub/dbgpt_hub/data/DuSQL/db_schema.json
