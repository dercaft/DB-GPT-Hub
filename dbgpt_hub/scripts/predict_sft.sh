...
CUDA_VISIBLE_DEVICES=0  python dbgpt_hub/predict/predict.py \
    --model_name_or_path /mnt/82_store/xzh/3.27_save/omni_w2a16g128_sqlcoder-7b-2_DuSQL_ft \
    --template llama2 \
    --finetuning_type none \
    --predict_batch_size 1 \
    --predicted_input_filename dbgpt_hub/data/example_text2sql_dev.json \
    --predicted_out_filename dbgpt_hub/output/pred/sqlcoder_2bit_${current_date}.sql
...
CUDA_VISIBLE_DEVICES=0  python dbgpt_hub/predict/predict.py \
    --model_name_or_path /mnt/82_store/xzh/3.27_save/omni_w2a16g128_MindSource-7B-sft_DuSQL_ft \
    --template llama2 \
    --finetuning_type none \
    --predict_batch_size 1 \
    --predicted_input_filename dbgpt_hub/data/example_text2sql_dev.json \
    --predicted_out_filename dbgpt_hub/output/pred/mindsource_2bit_${current_date}.sql
