...
# "/mnt/store/llama2-checkpoints-plus-sft-v3/checkpoint-14000/"  "codellama/CodeLlama-13b-Instruct-hf"
output_dir="dbgpt_hub/output/adapter/sqlcoder-sql-lora"
...
# 多卡，deepseed启动，A100
deepspeed --include localhost:4,5,6  dbgpt_hub/train/sft_train.py \
...
# 多卡，deepseed，全量微调
# deepspeed --num_gpus 4  dbgpt_hub/train/sft_train.py \
#     --dataset example_text2sql_train \
